...
INSERT INTO tblReturns (invoiceID, reason, status) 
VALUES 
(1, N'Sản phẩm bị lỗi kỹ thuật', 'pending'),
(2, N'Không đúng mô tả sản phẩm', 'approved');
...
INSERT INTO tblCustomerCares (userID, subject, content, status, reply)
VALUES 
('user002', N'Vấn đề sản phẩm', N'Sản phẩm nhận được không đúng mô tả.', 'new', NULL),
('user003', N'Tư vấn mua hàng', N'Tôi muốn biết thêm về sản phẩm Macbook Air M1.', 'answered', N'Cảm ơn bạn đã quan tâm, nhân viên sẽ liên hệ trong 24h.');
