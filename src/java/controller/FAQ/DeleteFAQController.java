 ...
 * @author User
 */
@WebServlet(name = "DeleteFAQController", urlPatterns = {"/DeleteFAQController"})
        ...
        try {
            ...
            if (faqIDRaw != null && !faqIDRaw.isEmpty()) {
                ...
                if (dao.deleteFAQ(faqID)) {
                    request.getSession().setAttribute("MSG", "Xóa FAQ thành công!");
                } else {
                    request.getSession().setAttribute("ERROR", "Xóa FAQ thất bại!");
                }
            }
