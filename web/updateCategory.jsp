    ...
    <body>
        ...
        <div class="wide-form-layout single">
            ...
            <form action="MainController" method="post" enctype="multipart/form-data" class="wide-form single-column">
                ...
                <div class="form-group">
                    <label class="form-label">Ảnh danh mục (chọn nếu muốn thay)</label>
                    <input type="file" name="image" class="form-file" accept="image/*">
                    <input type="hidden" name="oldImageUrl" value="${category.imgUrl}" />
                    <c:if test="${not empty category.imgUrl}">
                        <img src="${pageContext.request.contextPath}/${category.imgUrl}" alt="Ảnh danh mục" width="150" style="margin-top:10px; border:1px solid #ddd; border-radius:6px;"/>
                    </c:if>
                </div>
