...
<div class="wide-form-layout single">
    ...
    <form action="MainController" method="post" class="wide-form single-column">
        <div class="form-group">
            <label class="form-label">Mã coupon <span>*</span></label>
            <input type="text" name="code" class="form-input" placeholder="Nhập mã coupon, ví dụ: SALE10" required>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="number" name="quantity" min="1" class="form-input" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-bottom">
            <button type="submit" name="action" value="createCoupon" class="form-button">+ Thêm mã giảm giá</button>
